...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/08/wtwh7-cover.png"
slug = "jul21"
...
* I started [building the best career course](__GHOST_URL__/jul21/#building-the-best-career-course-on-the-internet) on the internet. (Why to aim low, right?)
* I worked on my **** storytelling skills, and I'll share my favorite resources to help you [be a better storyteller](__GHOST_URL__/jul21/#everyone-needs-to-be-a-better-storyteller).
* I had [mixed feelings about my Twitter experience](__GHOST_URL__/jul21/#an-introvert-struggling-with-twitter), and I'm talking about what's wrong and what I'll do to improve it.
...
{{< figure src="__GHOST_URL__/content/images/2021/08/enjoying-shit.png" caption="Do work you enjoy doing just because." >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/08/ms-dyw-banner.png" caption="MetaSprint.net (website in progress)" >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/08/architect.png" caption="Get things under control. Be more mindful about what you do, how, and why." >}}

So what does it mean to "design a better work-life"?

Well, I look at this question on 3 levels:

1. **Meaning** = **Why** do you work?
2. **Projects** = **What** do you work on?
3. **Systems** = **How** do you work?

{{< figure src="__GHOST_URL__/content/images/2021/08/dyw-system.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/08/10-years-crackling.png" caption="There's a lot of stuff out there." >}}
...
1. **Tweet** a lot about the ideas I'm considering for the course and pay attention to what resonates, what people don't understand, and improve them. Twitter is an excellent tool for refining ideas because it forces you to be brief.
2. **Write articles** from ideas that feel strong enough to be explored further. Writing an article is one of the best ways to sharpen your thinking about anything because you're trying to explain it to others. Teaching is the best way to learn anything.
3. **Create short videos** with me explaining ideas while drawing them on my iPad. This pushes my comfort zone from text to video, which is more fun to follow than articles. Also, making short videos from text demands zooming in on the essence of the material.
4. **Coach people**  **1:1** on designing their work-life to better understand how these ideas work in different situations. Coaching is mostly listening and asking good questions, which is useful for a deeper understanding of the problems you're trying to solve.
...
{{< figure src="__GHOST_URL__/content/images/2021/08/idea-funnel.png" caption="This almost makes sense. (It's work in progress.)" >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/08/storytellers.png" caption="We are born storytellers. We just need to practice." >}}

I'm looking at [how standup comedians think about storytelling](https://www.youtube.com/watch?v=OKY6BGcx37k). I'm looking at Pixar and how they craft their stories. And I'm looking at writers who are masters of using storytelling as a vehicle for what they're trying to say ([like the maker of Rick and Morty](https://www.youtube.com/watch?v=RG4WcRAgm7Y)).
...
* **Level 1** (start here): [Brains podcast with Tim Urban and Jason Silva](https://www.brainspodcast.com/episode/storytelling) – This is something you can listen to while doing something else. A great place to start without much effort.
* **Level 2** (if you want more): [Julian's deconstruction of storytelling](https://www.julian.com/blog/storytelling) – This is an article, so you have to put more work into it. But it's well worth the read if you want to understand how masters storytellers grab your attention and don't let go.
* **Level 3** (you want to go deep): [The Art of Storytelling](https://www.khanacademy.org/computing/pixar/storytelling) by Pixar **** – A free online course from storytellers at Pixar who might be the best in the movie industry. It takes 2-3 hours, and it's partially about visual storytelling. I binged it in one evening. So good.
...
{{< figure src="__GHOST_URL__/content/images/2021/08/didnt-enjoy-enough.png" caption="I'm gonna die defending this hill. Work should be fun." >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/08/friend-score.png" caption="Good math makes good friendship." >}}
