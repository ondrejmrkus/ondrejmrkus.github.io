...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/12/1-1.png"
slug = "21"
tags = ["Reflections"]
...
1. Right off the gate, I burned myself out on writing about [my monthly review process](__GHOST_URL__/20/). It was 3-4 times longer than my usual Monday post, taking over 8 hours of work. Not a good idea to push myself to finish 2k words in 1 day. Lesson learned.
...
{{< figure src="__GHOST_URL__/content/images/2021/12/2-1.png" caption="Unclear next step breaks my workflow." >}}
...
My only current output routine is sharing this [weekly reflection](__GHOST_URL__/tag/reflections/) every Monday. I sit down to write it in the morning and hit the publish button in the afternoon.
...
{{< figure src="__GHOST_URL__/content/images/2021/12/Scannable-Document-on-12.-12.-2021-11_22_40.png" caption="Inputs → Outputs → Results" >}}
...
As I said, my input routine works well. I’m there at my table every morning, doing the most important work of the day (writing) [without interruptions](__GHOST_URL__/no-meetings/).
...
{{< figure src="__GHOST_URL__/content/images/2021/12/3-1.png" caption="Shooting outputs at the right results." >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/12/adf.png" caption="Killing the weak" >}}
