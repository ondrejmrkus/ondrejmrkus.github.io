...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/03/innovation-design-cover.jpg"
...
The truth is, it's not really _a job_. Well, I mean, it can be. My "official" job description is an _innovation designer._
...
{{< figure src="__GHOST_URL__/content/images/2021/03/innovation-designer.jpg" caption="Innovation designer" >}}

## What makes an innovation designer

An innovation designer thinks and acts like a **scientist**.

* They look at **problems as opportunities for progress**
* They **aren't afraid of failure** because they know that's the only way to learn
* They **embrace ambiguity and complexity** of difficult problems
* They **know how to talk to people** to understand their needs better than they do
* They are **economical in their process** (lazy but in a good way). They always look for the most effective way to achieve the next step.
* They **see everything as an assumption** (hypothesis) that shouldn't be argued about but tested for data that will help them understand how things really work
...
Now, if you're at the beginning: whether you're a student thinking about innovation design as a career, or anyone looking to get better at making useful things people actually want, the best way to start is to **learn by doing**. Start like I did when I was 18 and [build something that doesn't work](__GHOST_URL__/build/).

It would be better if the things you make are working, that's for sure. But to be honest, it doesn't matter. We all have to make the same mistakes to truly understand _why_ they're mistakes. The success of what you are creating is secondary when your primary goal is to learn.

Creating something from scratch is a priceless experience no one can provide you with words or fancy design methods. The only way to become a good maker – to work as an innovation designer – is to [make things poorly until they aren't bad anymore](__GHOST_URL__/2020/).
