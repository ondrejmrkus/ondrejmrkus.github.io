...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/04/wtwh-3-cover.png"
slug = "mar21"
...
This reveals various things about me (and _you,_ if you know these feelings):
...
{{< figure src="__GHOST_URL__/content/images/2021/04/show-me-your-work.png" caption="Judging myself every day." >}}
...
[Daily journaling](__GHOST_URL__/journaling-rules/) is the backbone of my system – it's the first thing I do every morning after I sit down with a coffee and open my laptop.
...
{{< figure src="__GHOST_URL__/content/images/2021/04/journal-page-screenshot.png" caption="A screenshot of my daily journal page from 7th April" >}}
...
I'm going to write more about that soon. ([Join the email list](__GHOST_URL__/mar21/#/portal) to get it when it's ready.)
...
Bonus: Ask some wild **What if's**_._
...
And if you come up with some good **What if's** – [let me know](mailto:o@ondrejmarkus.com). I'm curious.
...
I finished 3 segments of content for weekly online sessions with students participating in the [Innovation lab](https://www.inovacnilaborator.cz/) (a seminar I co-create under the Charles University in Prague).
...
Our team in [The Greenest Company](https://www.grnst.co/) continues working on the app for HR managers that helps them understand what their employees need to be happier and more productive.
...
I returned to writing articles and I want to write more and consistently. I finished 2 articles this month, plus I made a new intro page for my [Student Entrepreneur Guide](__GHOST_URL__/student-guide/).

**Finished articles**:

* [The unexpected value of innovation design for anything you do](__GHOST_URL__/innovation-design/)
* [3 levels of becoming an innovator](__GHOST_URL__/3-levels/)
...
So please [tell me](mailto:o@ondrejmarkus.com) what you liked and didn't like. I'd be very grateful to know.
