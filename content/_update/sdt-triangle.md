...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/05/trinangle-cover-1.png"
slug = "sdt-triangle"
...
And the best framework I found so far is the **[Self-determination theory](https://uvi.edu/files/documents/College_of_Liberal_Arts_and_Social_Sciences/social_sciences/OSDCD/National_Self_Determination_Richard_Ryan_and_Edward_Deci.pdf)** (SDT). It's a motivation theory heavily backed by scientific evidence and it seems to be valid in all cultures.
...
{{< figure src="__GHOST_URL__/content/images/2021/05/map-compass.png" caption="Maps are useful because they are simplified versions of reality." >}}
...
Whenever I feel something is wrong, it helps me figure out where exactly are the sources of dissatisfaction, understand their causes, and decide what I should do to fix them. (I mostly do this when writing my [Morning Pages](__GHOST_URL__/mp/).)
...
{{< figure src="__GHOST_URL__/content/images/2021/05/diserve-existance.png" caption="Me judging myself based on the work I do." >}}
...
So as a rookie writer, I feel very challenged and learning fast. It's more about where I'm heading than where I am right now. Just yesterday I committed to [writing 100 articles in 100 workdays](__GHOST_URL__/writing-loop/) to kickstart my learning even more.
