...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2022/02/finding-yourself-cover.jpg"
...
{{< figure src="__GHOST_URL__/content/images/2022/02/uncertain.jpg" caption="Trust in the process" >}}

I embrace the process of finding myself as I go – _by trial and error_ – but that doesn't mean it's not frustrating.
...
That's why I'm committed to working here with my [garage door open](__GHOST_URL__/open-garage/). I want to share pieces of the process along with what I make.

_Am I confident this project will work out?_
...
1/ **Overconfidence**: _A belief that your chances of success are higher than they actually are._

2/ **Self-fulfillment**: _Being satisfied by the process of doing something even if it doesn't succeed._
...
_(Read "succeed" as "make a living and create significant value for others.")_

I could also call it optimism if I wanted to be nicer. I don't.

{{< figure src="__GHOST_URL__/content/images/2022/02/overconfidence.jpg" caption="Purposeful overconfidence" >}}
...
_So, what's my point here?_

**Nobody knows what they're doing half the time.**

So if you're in the _'I don't know shit'_ place right now, just do something you enjoy on its own. That guarantees it will be worth it even if it doesn't lead to any tangible result.
