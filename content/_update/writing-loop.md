...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/05/learning-loop-cover.png"
slug = "writing-loop"
...
{{< figure src="__GHOST_URL__/content/images/2021/05/12hoursin.png" caption="Writing sometimes feels worse as time goes." >}}
...
* Spend 20 minutes connecting with people on **Twitter** (using best practices from [Making Twitter friends](https://www.makingtwitterfriends.com/))
...
{{< figure src="__GHOST_URL__/content/images/2021/05/learning-loop.png" caption="Doing this every day for the next 100 days." >}}
...
* **Quantity is the shortest way to reach quality**. The more shots you can take on a target, the higher is the chance you will hit it. And if you can learn to shoot every day, you can take 100 shots in a time you'd otherwise make 10 or 15. So even though quality is the ultimate target, [quantity seems to be the necessary vehicle you need to get there](__GHOST_URL__/quantity/).
...
{{< figure src="__GHOST_URL__/content/images/2021/05/supposedtodowhat.png" caption="Yesterday's Me is an optimist..." >}}
