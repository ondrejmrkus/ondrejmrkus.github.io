...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2020/11/build-something.png"
slug = "build"
...
Every time I look back, I wonder: "Why the hell I did _this_ right after finishing 4 years of computer technology?"

{{< figure src="__GHOST_URL__/content/images/2020/11/mittens.png" caption="My sophisticated mitten-storage solution. Patent pending." >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/11/business-idea1.png" caption="High-school business class lesson 1" >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/11/mitten-based.png" caption="Tread lightly please. You are stepping on my dreams." >}}
...
My starting point: _$800 + the ability to google things_, was nothing to write home about, but I was ready to roll.
...
{{< figure src="__GHOST_URL__/content/images/2020/11/mitten-models.png" caption="Mittens pictures I used on the e-shop, Instagrams, and such." >}}

{{< figure src="__GHOST_URL__/content/images/2020/11/mitten-product.png" caption="Product pictures a friend made for me in her home studio." >}}
...
{{< figure src="__GHOST_URL__/content/images/2020/11/hitting-refresh.png" caption="It was a stressful week.." >}}

Overall, I sold 9 more pairs from my stock of 53 items. 3 of them bought by my mom and friends.

The problem was in my belief that if you build a thing, people will find it, like it, and buy it. I didn't know what _marketing_ is. I didn't promote my products anywhere. And waiting for strangers to discover you in the internet ocean hasn't proved to be an effective strategy.
...
In about a month, I read an article about a young entrepreneur in Prague who lead a studio developing mobile apps and games. I really liked what they were doing, and they had a job opening for a _project manager_. I had no idea what that meant, but I emailed them that I would like to work there. What's the worst that could happen, right?
...
{{< figure src="__GHOST_URL__/content/images/2020/11/chandler-dancing.gif" >}}

We met the next day, and I got the job. One I would gladly do for free to be around and learn from those guys. So getting paid for it was a dream scenario. It changed my life by showing me [I can truly enjoy the work I do](__GHOST_URL__/meaningful-work/). And it was the failed mittens business that made it possible.
...
{{< figure src="__GHOST_URL__/content/images/2020/11/show-mistakes.png" caption="Your mistakes are valuable experience." >}}
...
He knew, as an entrepreneur himself, that there is no way to avoid mistakes when you build something from scratch. To [make lots of mistakes and learn from them](__GHOST_URL__/quantity/) is infinitely more impressive than not making any. Because the only way to make no mistakes is to do nothing, and no one is impressed by that.
