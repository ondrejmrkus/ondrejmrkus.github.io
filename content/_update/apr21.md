...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/05/wtwh4-cover.png"
slug = "apr21"
...
It looks like I'm never gonna shut up about the benefits of these monthly reflections. So here it comes: They're _good_. Try it sometime.
...
1. **How much deep work am I doing every day?** (● = 1 Pomodoro = 25 minutes)
2. **How do I feel on any given day from 0 to 10?** (0 = I died, 10 = please god let me repeat this day forever)
...
{{< figure src="__GHOST_URL__/content/images/2021/05/notion-monthly-journal-1.png" caption="Monthly view of my Notion journal" >}}
...
The thing is: Investing isn't interesting to me. It seems like _(sometimes)_ intelligent gambling. If anything, I'd put money somewhere long-term where they compound over time. Short-term speculation isn't for me. I don't like to spend the mental and emotional energy on investing.

But that doesn't mean that my brain isn't bothering me with the fear of missing out on a _HUGE OPPORTUNITY_ (his words). So even though I rationally don't want to be bothered by crypto and focus on the work I actually enjoy instead, it doesn't let me off the hook so easily.

**The FOMO loop works like this:**

1. I hear about someone getting rich on crypto.
2. My brain yells at me: "Don't be stupid and buy some! Look it up and get in the game, son."
3. I get anxious.
4. But then I remember that I don't care about investing in stuff.
...
I'm considering the challenge of publishing **100 articles in 100 workdays** (5 per week). I read about it [here](https://nesslabs.com/100-articles-100-days), and at first, I dismissed it as madness. But then after about a week of pondering, it doesn't seem so crazy anymore. I could use some madness.

{{< figure src="__GHOST_URL__/content/images/2021/05/me-vs-100articles.png" caption="Me vs. 100 articles" >}}
...
As I started writing one article every week in April, I realized I would like to publish under a website that isn't just _my name_. I don't know why exactly, I guess I just like the idea of a separate website for my writing rather than sharing everything as _me_.
...
{{< figure src="__GHOST_URL__/content/images/2021/05/Screenshot-2021-05-09-at-11.36.33.png" >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/05/metasprint-start-end.png" >}}
...
* [How to find a productivity system that works for you](__GHOST_URL__/system-that-works/)
...
The last weekend of April I spent playing board games with friends after a long time. We played [Cosmic Encounter](https://boardgamegeek.com/boardgame/39463/cosmic-encounter), [Cyclades](https://boardgamegeek.com/boardgame/54998/cyclades), [Arcadia Quest](https://boardgamegeek.com/boardgame/155068/arcadia-quest), and a little bit of Poker.

## Listening 🎧

Every day I can, I hop on a bike for a 30-minute ride with Alan Watts in my ears. It keeps my sanity levels above livable during a busy month. (Excellent not just for deflecting [crypto FOMO](__GHOST_URL__/april21/#my-dear-crypto-fomo/).) Highly recommended.
