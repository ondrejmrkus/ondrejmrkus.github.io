...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2022/06/why-dont.jpg"
slug = "why-dont"
tags = ["Reflections"]
...
{{< figure src="__GHOST_URL__/content/images/2022/06/snooze-dreams.jpg" caption="Hitting the Snooze button on what I really want to do." >}}

But.

I _really_ do want to write. I mean, I published [26 articles](__GHOST_URL__/archive/) between January and March of this year. I enjoy this stuff.

So what is _actually_ happening here?
...
{{< figure src="__GHOST_URL__/content/images/2022/06/jammed-full.jpg" >}}

A few months ago, I wrote about the [TEA framework](__GHOST_URL__/fund-yourself/#protect-your-tea): How creating space for activities is about managing three resources at once – **Time**, **Energy**, and **Attention**.

{{< figure src="__GHOST_URL__/content/images/2022/06/3-ingredients-of-TEA.jpg" caption="3 ingredients of a good TEA" >}}

Whenever we say, _"I want to do X but I don't have time for it."_ it often means we do have the time, but we are too exhausted _(not enough energy)_ or mentally overwhelmed _(not enough attention left)_.
...
This seems to be my case over the last month. I was out of mental capacity _(attention)_ to finish a single piece of writing.
...
{{< figure src="__GHOST_URL__/content/images/2022/06/chewing-on-tasks.jpg" caption="Chew for your life, man!" >}}
...
First, you need some more context: During my [Q1 reflection](__GHOST_URL__/2022-q1/), I decided I want to write about games and, in a couple of months, pursue a job as a game designer.

It was a surprise that came from [weeks of calm strategic reflection](__GHOST_URL__/prime/). _(I sincerely recommend everyone to take a month off to just think about life. It's magic.)_

Anyway.

This means I wasn't postponing just writing, but writing about the topic that feels most interesting and close to me right now _(games)_. And it's been very close to me for ages. I just never allowed myself to pursue it "_professionally_."

_(Why not is for another therapeutic writing session. Maybe next time.)_
...
I mean, when we fail at things we don't really care about, it's easier to shake that off as _"Oh well, that sucks, but it didn't really matter to me."_

But when we do care a ton, we can't deflect the crushing fear of _"What if I suck at what I love the most?"_

And even though I believe all of us have to [be bad before we get good](__GHOST_URL__/bad-to-good/) at anything, I can't tell if my subconscious knows it too.

Do you, Steve?

{{< figure src="__GHOST_URL__/content/images/2022/06/steve.jpg" >}}
...
It's easier to find a decoy, an excuse, a target to blame and say: _"Well, I would love to do X but I just don't have the time/energy/attention to do so right now. I'll do it next year."_

So what if I'm creating this _"attention deficit problem"_ to protect myself from failing at game design?
...
So, are my _"practical excuses"_ really true?
...
{{< figure src="__GHOST_URL__/content/images/2022/06/liar-prove-it.jpg" caption="Prove your words with actions." >}}
...
_(Or maybe never if my brain decides the shame is unbearable. Yayx.)_
...
Let me know if this is boring or not. And if you've ever been in a similar situation, [I'm curious to know](mailto:o@ondrejmarkus.com) how you solved it.
