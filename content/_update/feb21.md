...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/03/wtwh2-cover.jpg"
slug = "feb21"
...
1. [Why I failed to write 14 fiction stories](__GHOST_URL__/feb21/#why-i-failed-to-write-14-fiction-stories)

2. [Why I gave this chatbot a weird personality](__GHOST_URL__/feb21/#why-i-gave-this-chatbot-a-weird-personality)

3. [How we run a 50 student Innovation lab](__GHOST_URL__/feb21/#how-we-run-a-50-student-innovation-lab)

4. [Why I want to start another online course](__GHOST_URL__/feb21/#why-i-want-to-start-another-online-course)

5. [Why I redesigned my productivity System](__GHOST_URL__/feb21/#why-i-redesigned-my-productivity-system)
...
## Why I failed to write 14 fiction stories

[Last month](__GHOST_URL__/jan21/), I committed to finishing 14 fiction stories in any shape or form, because I wanted to practice storytelling as a tool for communication.
...
1. I make my goals **huge** (14),

2. **long-term** (in a month),

3. and **generic** (fiction stories).
...
### My unimpressive fiction writing results
...
{{< figure src="__GHOST_URL__/content/images/2021/03/working-vampires.jpg" caption="I couldn't bring myself to coloring it." >}}
...
## Why I gave this chatbot a weird personality

I'm a part of a [team](https://www.qdesigners.co/about-cz) that's working on a [web application](https://www.grnst.co/) that measures the wellbeing of people in companies. We use a chatbot to collect data in their Slack or MS Teams and it asks the employees some simple questions.
...
{{< figure src="__GHOST_URL__/content/images/2021/03/green-meets-humans.jpg" caption="Green meets humans #1" >}}
...
## How we run a 50 student Innovation Lab

Another project I haven't mentioned before is co-creating the [Innovation lab](https://www.inovacnilaborator.cz/).
...
There are two of us: [Jan Veselý](http://vese.ly/), a friend and the original author who founded the Innovation lab 3 years ago and has done six runs so far. I joined him in the last 2 runs.
...
1. completely re-think the structure,

2. facilitate 50 people into teams.

### Challenge 1: Re-think the structure
...
However, there is [research](https://www.tandfonline.com/doi/pdf/10.1207/s15326985ep4102_1?needAccess=true&) indicating that **unguided methods don't work very well for beginners**. The unguided approach works best once the students are advanced enough to (at least somewhat) know what to do.
...
### Challenge 2: Facilitate 50 people into teams
...
## Why I want to start another online course
...
1. As I said, I want to **get better at running live cohort-based online courses**, because I think it's the best way to **learn by doing**. And an even better way to meet people from different backgrounds.
...
2. I want to **be a part of a creative co-work group**. Yes, I'm an introvert who flourishes on being alone (lockdown is heaven for me). But I also lack a group of peer creators who do things like writing blogs, starting businesses, making videos, running online courses, etc.
...
### MetaSprint #2 (beta) website prototype
...
## Why I redesigned my productivity System

Remember when I said earlier that my **goal setting doesn't work** and that I found a solution but will talk about it later? Well, now is the _later_.
...
### I can't work on anything until it's a project.

I'll explain. _(#NerdAlert)_
...
{{< figure src="__GHOST_URL__/content/images/2021/03/goal-wishing-well.jpg" caption="Goal wishing well" >}}
...
And I've talked before about how [I learn much better when I work on a concrete project](__GHOST_URL__/jan21/) I am excited to finish, instead of just following instructions of a video-course or something like that. I need projects to make meaningful progress on anything. It's just better in every case I can think of.

So I'll push things a little into the extreme and make a rule: **I can't work on anything until it's a project**.

{{< figure src="__GHOST_URL__/content/images/2021/03/project-or-nothing.jpg" caption="Project or nothing." >}}
...
By the way, that's one reason why I write these [reflections](__GHOST_URL__/tag/reflection/) – to catch myself doing non-sense like this. And hopefully to help you avoid it altogether.
