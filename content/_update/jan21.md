...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/02/january-21.jpg"
slug = "jan21"
...
* links to my new work
* plans of what's coming next
* updates on sudden existential crises
...
1. **[2020: The ballad for bad work](__GHOST_URL__/jan21/#2020-the-ballad-for-bad-work)** (writing)
2. **[Comic book: První hráči](__GHOST_URL__/jan21/#prvn-hr-i)** (writing + drawing)
3. **[Meaningful work guide 2.0](__GHOST_URL__/jan21/#meaningful-work-guide-2-0)** (research)
4. **[JavaScript practice](__GHOST_URL__/jan21/#javascript-practice)** (learning to code)

I'll go through them one by one. Feel free to skip to whatever interests you, of course.

### 2020: The ballad for bad work

I like to start the new year by [**properly looking back**](__GHOST_URL__/2020/) at the last one. Going through my journals helps me to understand myself a little better. (And/or wonder what the hell am I trying to do with my life). In either case, I can mentally move on.
...
{{< figure src="__GHOST_URL__/content/images/2021/02/prvni-hraci-preview-1.jpg" caption="A comic book I made" >}}

### Meaningful work guide 2.0

There is an improved 2.0 version of [**How to find meaningful work**](__GHOST_URL__/work-guide/) in my head. The problem is, it would take like 200+ hours to get it out. Nevertheless, I slowly started with the research: mostly [self-determination theory](https://en.wikipedia.org/wiki/Self-determination_theory).
...
Future _me_ approves of the idea but doesn't like the amount of work needed. I'll let you know which one wins.
...
I've started a [Udemy course on JavaScript](https://www.udemy.com/course/modern-javascript-from-the-beginning/), but that **didn't work** for me at all. When I watch a video course, I tend to follow for a while, then get bored of just mirroring what the teacher is doing, and I quit.
...
## Two habits I shoved into my life
...
1. **Meditate** every day for at least 5 minutes (again)
2. Do **spaced repetition** every day

This is how I did with meditation (you can see my new un-sophisticated tracking system):

**O** = I did it‌‌ / **X** = I didn't

{{< figure src="__GHOST_URL__/content/images/2021/02/2.jpg" caption="Meditation habit streak" >}}

### Meditation fail

(A paragraph of _more-than-you-wanted-or-needed-to-know_ about why I've failed meditation:)

I absolutely failed with meditation. It dropped off in the middle of the month, and I'm not sure why. One guess is that I didn't really set a specific moment of the day to do it and just hoped _"there will be a good moment to do 5 minutes – I mean, cmon, it's FIVE minutes"_. But as it turns out, it wasn't happening.
...
{{< figure src="__GHOST_URL__/content/images/2021/02/meditation-failed.jpg" caption="aaaaaaagh!" >}}

Also, in the morning, I'm impatient to make coffee (because it's delicious), and putting meditation as an obstacle in front of that wasn't probably a good idea anyway (all I was thinking during meditation was that I want to make coffee). And I couldn't do it _after_ making the coffee because then the coffee would get cold as I meditated. Ahh. _#ZerothWorldProblems_
...
The right word is _grateful_ I think. Moving on.
...
**Spaced repetition** is a way to deliberately think about and remember things you actually want in your brain. There is more than one way to do it, but people usually use an app like [**Anki**](https://apps.ankiweb.net/) (free, opensource).
...
I won't go into any more detail. If it sounds interesting to you, check this [**interactive comic strip**](https://ncase.me/remember/) that explains it better than I could.
...
{{< figure src="__GHOST_URL__/content/images/2021/02/1.jpg" caption="Spaced repetition habit streak" >}}

The goal is to use it for learning Javascript and other things, plus putting prompts there that keep my attention on questions and topics I want to think about. Like a quote I want to bump into from time to time: _"Who is not satisfied with little, is satisfied with nothing."_ Or a question I want to burn into my brain: _"What transition should be between every line you write to keep the story interesting?"_ (it's _therefore_ or _but,_ [according to the makers of South Park](https://vimeo.com/123759973)).

---

## My plans for February

1. **Write fiction stories**
...
So sometimes it's maybe better to not just tell people "_be more courageous even if you're scared_" but to show them a story about someone being brave despite their fears.
...
For most of the last year, I focused on _writing_ articles. Then I added more and more pictures into them, which later evolved into occasional comic-making. Now, I want to make interactive things with JavaScript, and use more fictional storytelling to convey what I want to say, instead of non-fiction _do-this-to-get-that_ kind of articles.
...
And if you got here from elsewhere than my email list. [**Subscribe**](__GHOST_URL__/#/portal) to stay in touch.
