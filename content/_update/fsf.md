...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/09/1.png"
slug = "fsf"
...
This approach defines a new kind of worker called the Full-Stack Freelancer, which I first found in [an article](https://medium.com/praxis-blog/the-rise-of-the-full-stack-freelancer-c14a375445d9) by Tiago Forte.
...
{{< figure src="__GHOST_URL__/content/images/2021/09/2.png" caption="Organizing work into projects opens new possibilities." >}}
...
<div class='c-note c-note--info'>
  <p><b>Example: My portfolio of projects (August 2021)</b></p>
<ul>
...
{{< figure src="__GHOST_URL__/content/images/2021/09/3.png" caption="Experiments help you test ideas before you fully commit to them." >}}
...
<div class='c-note c-note--info'>
    <p><b>Example: Developing a new course in 3 weeks</b></p>
...
**The Full-Stack Freelancer creates synergy between his projects by weaving them into one network** to exploit the [network effect](https://en.wikipedia.org/wiki/Network_effect):
...
{{< figure src="__GHOST_URL__/content/images/2021/09/fsf-network.png" caption="Treat your work as a network of people and projects." >}}
...
<ul>
    <li><a href="__GHOST_URL__/">This website</a> is my online home connecting all my projects.</li>
...
{{< figure src="__GHOST_URL__/content/images/2021/09/fsf-skills.png" caption="Often it's better to choose to learn more over getting extra income." >}}

**Example: Bootstrapping a business**

When I was 19, I used all my savings (~$1000) to [start my first business](__GHOST_URL__/build/). It bankrupted in 6 months, but it was the best learning experience I ever had.
...
<div class='c-note c-note--info'>
   <p><b>Example: Bootstrapping a business</b></p>
    <p>When I was 19, I used all my savings (~$1000) to <a href="__GHOST_URL__/build/">start my first business</a>. It bankrupted in 6 months, but it was the best learning experience I ever had.</p>
...
{{< figure src="__GHOST_URL__/content/images/2021/09/4.png" caption="Use technology as leverage for change in the world." >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/09/fsf-identity.png" caption="Think about work in verbs rather than nouns." >}}
...
<div class='c-note c-note--info'>
    <p><b>Example: Shifting work identity</b></p>
...
{{< figure src="__GHOST_URL__/content/images/2021/09/fsf-lifestyle.png" caption="Design a life you enjoy living." >}}

<div class='c-note c-note--info'>
  <p><b>Example: Designing my lifestyle</b></p>
<ul>
    <li>My energy peak is in the morning, and I prefer working alone. So I have a rule: “<a href="__GHOST_URL__/no-meetings/">No meetings before noon</a>.” I don’t pick up the phone, do emails, or schedule meetings until 12 am. I protect my prime time.</li>
...
> 1. **Write down every project** you're working on – anything you spend your time on and is related to work: Your job, business, side projects, school, courses, blogs, social media, etc.
...
> 2. **Analyze every project** individually and ask: **What makes this project worth my time?** Look for streams of income, skills, relationships, and contribution.

> 3. **Think about what you could change** to create a balance of income, skills, relationships, and contribution, that works best for you.- What would you like to remove or do less?- What would you like to add or do more?

This will give you specific ideas on how to improve your work.

---

P.S.: I'm writing another article about **how to design your portfolio of projects**. It's going to be ready soon. [Subscribe here](__GHOST_URL__/#/portal) to get it.
