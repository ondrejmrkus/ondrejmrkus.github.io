...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/04/3-levels-innovators.jpg"
slug = "3-levels"
...
→ Level 1: [Start before you feel ready](__GHOST_URL__/3-levels/#1-start-before-you-feel-ready/)

→ Level 2: [Learn in faster feedback loops](__GHOST_URL__/3-levels/#2-learn-in-faster-feedback-loops/)

→ Level 3: [Focus on the problem, not your solution](__GHOST_URL__/3-levels/#3-focus-on-the-problem-not-your-solution/)
...
{{< figure src="__GHOST_URL__/content/images/2021/04/leap-of-faith.jpg" caption="Make the leap and start" >}}

### Act first to understand later
...
I've [built something that didn't work](__GHOST_URL__/build/), spent all my savings on it, but I survived just fine. More than that – it got me my first job that kickstarted my life in unexpected ways.
...
It's the best thing I ever did for myself. Not the business idea – that was rubbish – but the move itself was outstanding. If I had a time machine, I would go back and hug my 18-year-old self for being so [hungry and foolish](https://news.stanford.edu/2005/06/14/jobs-061505/).
...
## 2. Learn in faster feedback loops
...
### Don't work in secret, tell people

{{< figure src="__GHOST_URL__/content/images/2021/04/secretss.jpg" caption="People don't want to steal your ideas." >}}
...
1. I made something (in 6 months),
2. and then I showed it to people.
...
{{< figure src="__GHOST_URL__/content/images/2021/04/show-people.jpg" caption="The sooner you see what people don't understand about your idea, the sooner you can fix it." >}}

If people don't get it, change your idea. Adapt based on the feedback from your customers.

This is easier to do after one week of work than after one year of work. Because after you've worked on something for months or years, you are too invested both emotionally and financially. That's when [sunk costs](https://growth.design/psychology/#sunk-cost) get you stuck and unable to quit things that don't work. Avoid getting stuck.
...
1. Build a prototype
2. Test it (show it to people)
3. Learn from what does and doesn't work

And repeat until you run out of time, money, or energy to continue.

### Build, show, learn, repeat

{{< figure src="__GHOST_URL__/content/images/2021/04/innovation-feedback-loop.jpg" caption="Fast learning feedback loop" >}}
...
## 3. Focus on the problem, not your solution
...
{{< figure src="__GHOST_URL__/content/images/2021/04/love-the-problem.jpg" caption="Love the problem, not your solution." >}}
...
### Stay flexible until you understand the problem
...
{{< figure src="__GHOST_URL__/content/images/2021/04/ex-solutions-1.jpg" caption="It's not personal." >}}
...
A good rule of thumb is to  **never ask people what they _would_ do**, but  **always ask them what they actually _did_ ** in the past or are doing now.
...
* Do you work in fast feedback loops?
...
{{< figure src="__GHOST_URL__/content/images/2021/04/3-levels-of-becoming-an-innovator.png" caption="3 levels of becoming an innovator" >}}
...
* No one is ever truly ready for anything. Start small. Start today.
* Don't worry whether you're doing it wrong. There is no single best way to do things.
* The point is to get real experience. You need to make your own mistakes to really understand how this works. There is no way around that. The advanced theory works best when you can apply it to your own experience.

### Level 2: Learn in faster feedback loops

Once you're in the game – solving problems – start working in faster feedback loops.

* Don't work in isolation. Tell people about your ideas.
* Start making fast prototypes. Test them quickly and often. (One feedback loop = Build → Show → Learn)
* Don't be afraid of trial and error. It's the only way to figure out things no one has done before.
...
* Feel free to change your idea, or even adjust what problem you are trying to solve as you get more information.
* Learn to ask the right questions to get valuable insights instead of false data.
