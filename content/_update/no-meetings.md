...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/05/1-1.png"
slug = "no-meetings"
...
{{< figure src="__GHOST_URL__/content/images/2021/05/3-1.png" caption="Productivity goes down with time on my regular day" >}}
...
{{< figure src="__GHOST_URL__/content/images/2021/05/2-1.png" caption="People respect rules" >}}
...
But even if this particular rule is unrealistic for you, it doesn't mean you can't use a different rule to get the same benefits. The usefulness of rules is highly subjective anyway, and the point isn't to copy&paste mine's, but to [find rules that work for you](__GHOST_URL__/system-that-works/).
