...
description = ""
draft = false
image = "__GHOST_URL__/content/images/2021/07/wtwh-6-cover.png"
slug = "jun21"
...
{{< figure src="__GHOST_URL__/content/images/2021/07/mom-joke.png" caption="Explaining what I do to my mom" >}}
...
I see money as a ladder. A ladder that helps me climb a wall – takes me where I want to go. So I need to make sure my ladder is long enough.

{{< figure src="__GHOST_URL__/content/images/2021/07/money-ladder.png" caption="Money ladder $" >}}

The good news is, my ladder is long enough for now.
...
Good work is on the overlap of **what I do well** and **what others need**.

{{< figure src="__GHOST_URL__/content/images/2021/07/overlap-good-work.png" >}}

My problem is, **I struggle to pin down what others need** in what I want to do.
...
{{< figure src="__GHOST_URL__/content/images/2021/07/ld-triangle.png" caption="Life Design Triangle" >}}

These are huge questions. And I struggle to find the rights words to explain what value I'm trying to create for others without sounding too pompous and self-help-y.
...
I also feel this uncertainty in how I choose projects. I mostly decide what to work on by what _feels right_. I follow my own curiosity and problems, and I solve them.
...
* Am I missing something? [Tell me](mailto:o@ondrejmarkus.com).

### Work in progress

* **Design your life with Courage to be Disliked** – I spent over half of my time in June writing this article. It started as a summary of the [book,](https://www.goodreads.com/book/show/43306206-the-courage-to-be-disliked?from_search=true&from_srp=true&qid=4OrEyR8e6Z&rank=1) but it's turning into a guide for designing good relationships.

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Courage to be disliked feels like a crucial value for anyone in the <a href="https://twitter.com/hashtag/BuildInPublic?src=hash&amp;ref_src=twsrc%5Etfw">#BuildInPublic</a> community.<br><br>That&#39;s one more reason to extract its ideas into an illustrated book summary. [outline in progress]<br><br>Btw, first time trying <a href="https://twitter.com/RoamResearch?ref_src=twsrc%5Etfw">@RoamResearch</a> and loving it. <a href="https://t.co/q1eFkCb0g1">pic.twitter.com/q1eFkCb0g1</a></p>&mdash; Ondrej Markus (@ondrej_markus) <a href="https://twitter.com/ondrej_markus/status/1409475278452232196?ref_src=twsrc%5Etfw">June 28, 2021</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

### Shipped in June

* [What the work happened #5](__GHOST_URL__/may21/) – I'd like if these reflections took less time to write. But I can't help myself turning them into something that takes days to edit. I want them to be good.
...
My focus goes in a different direction – **Twitter**.

{{< figure src="__GHOST_URL__/content/images/2021/07/friend-what-tweets.png" caption="Friend what tweets" >}}
...
* **Joining a community** ✅ – I joined a [Public Lab community](https://publiclab.co/) to find like-minded builders which really helped me get the ball rolling. Twitter feels huge when you're there alone, so it's nice to find a smaller bubble to join.

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Twitter is hard for introverts.<br><br>But the <a href="https://twitter.com/hashtag/BuildinPublic?src=hash&amp;ref_src=twsrc%5Etfw">#BuildinPublic</a> community helps me get out of my shell, meet people across the world, and learn faster.<br><br>Yesterday, I met with <a href="https://twitter.com/MeetKevon?ref_src=twsrc%5Etfw">@MeetKevon</a>, and the energy and enthusiasm he puts into <a href="https://t.co/xIk4ZRAwJv">https://t.co/xIk4ZRAwJv</a> encourages me to keep going.</p>&mdash; Ondrej Markus (@ondrej_markus) <a href="https://twitter.com/ondrej_markus/status/1407626844837494786?ref_src=twsrc%5Etfw">June 23, 2021</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
{{< figure src="__GHOST_URL__/content/images/2021/07/Screenshot-2021-07-07-at-11.04.55.png" caption="My Twitter analytics in June" >}}

* The thing that seems low is the conversion rate from _Profile visits_ to _Followers_ (~ 1 %). It would probably improve if I had a better bio and cover. That's something to work on.
...
* If you've enjoyed this, share this link with a fellow builder who's on a similar journey: [ondrejmarkus.com/jun21](__GHOST_URL__/jun21)
* Also, [email me](mailto:o@ondrejmarkus.com) to say hello and tell me what you liked or didn't like. I have no idea what is good anymore.
* Lastly, [join my email list](__GHOST_URL__/jun21/#/portal) if you want to be the first to know when the **Courage to be Disliked guide** is ready.
